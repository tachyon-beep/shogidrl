    ...
    def test_future_parallel_environment_interface(self):
        ...
        class MockShogiEnvWrapper:
            ...
            def step(self, action):
                return MagicMock(), 0.0, False, False, {}  # obs, reward, terminated, truncated, info
        ...
        assert len(terminated) == 2, "Should get terminated flags from both environments"
        ...
        class MockSelfPlayWorker:
            ...
            def run(self):
                ...
                for episode in range(2):
                    ...
                    experience = {
                        'observations': [[0.1, 0.2, 0.3]] * 10,  # Mock observation arrays
                        'actions': [0] * 10,
                        'rewards': [0.1] * 10,
                        'values': [0.5] * 10,
                        'log_probs': [0.1] * 10,
