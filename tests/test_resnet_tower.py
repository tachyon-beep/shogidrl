...
def test_resnet_tower_forward_shapes():
    ...
    for c in [46, 51]:
        model = ActorCriticResTower(input_channels=c, num_actions_total=13527, tower_depth=9, tower_width=256, se_ratio=0.25)
...
def test_resnet_tower_fp16_memory():
    ...
    model = ActorCriticResTower(input_channels=51, num_actions_total=13527, tower_depth=9, tower_width=256, se_ratio=0.25)
...
def test_resnet_tower_se_toggle():
    ...
    model_se = ActorCriticResTower(46, 13527, tower_depth=3, tower_width=64, se_ratio=0.5)
    model_no_se = ActorCriticResTower(46, 13527, tower_depth=3, tower_width=64, se_ratio=None)
