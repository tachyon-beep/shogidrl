...
class TestSessionManagerTrainerIntegration:
    ...
    def test_trainer_uses_session_manager(self, mock_setup_seeding, mock_serialize,
                                         mock_setup_wandb, mock_setup_dirs,
                                         mock_feature_specs, mock_model_factory,
                                         mock_ppo_agent, mock_shogi_game,
    ...
    @patch('keisei.training.utils.serialize_config')
    @patch('keisei.training.utils.setup_seeding')
    def test_trainer_session_info_logging(self, mock_setup_seeding, mock_serialize,
                                         mock_setup_wandb, mock_setup_dirs,
                                         mock_feature_specs, mock_model_factory,
                                         mock_ppo_agent, mock_shogi_game,
                                         mock_config, mock_args):
    ...
    def test_session_manager_standalone_functionality(self, mock_config, mock_args):
        ...
        session_manager = SessionManager(mock_config, mock_args, run_name="test_session")
    ...
    @patch('builtins.open')
    @patch('os.path.join')
    def test_session_manager_full_workflow(self, mock_join, mock_open, mock_serialize,
                                         mock_setup_wandb, mock_setup_dirs,
                                         mock_config, mock_args):
...
class TestSessionManagerErrorHandling:
    ...
    def test_directory_setup_failure(self, mock_config, mock_args):
        ...
        with patch('keisei.training.utils.setup_directories', side_effect=OSError("Permission denied")):
    ...
    def test_wandb_setup_failure(self, mock_config, mock_args):
        ...
        with patch('keisei.training.utils.setup_wandb', side_effect=Exception("WandB error")):
    ...
    def test_config_saving_failure(self, mock_config, mock_args):
        ...
        with patch('keisei.training.utils.serialize_config', side_effect=TypeError("Serialization error")):
