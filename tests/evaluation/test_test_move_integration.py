...
from keisei.shogi.shogi_core_definitions import PieceType, Color, MoveTuple
...
class TestTestMoveVsMakeMove:
    ...
    def test_test_move_matches_make_move_validation(self):
        ...
        for move in test_moves:
            ...
            assert test_result == make_move_result, f"Mismatch for move {move}: test_move={test_result}, make_move={make_move_result}"
...
class TestAdvancedScenarios:
    ...
    def test_drop_rule_validation(self):
        ...
        for r in range(9):
            for c in range(9):
                game.set_piece(r, c, None)
        game.set_piece(6, 0, Piece(PieceType.PAWN, Color.BLACK))  # Existing pawn in file
        game.hands[Color.BLACK.value][PieceType.PAWN] = 1
