...
class TestBackgroundTournamentManager:
    ...
    def test_tournament_manager_lifecycle(self):
        ...
        with patch(
            "keisei.evaluation.core.background_tournament.BackgroundTournamentManager"
        ) as MockManager:
    ...
    def test_tournament_status_state_machine_validation(self):
        ...
        with patch(
            "keisei.evaluation.core.background_tournament.TournamentStatus"
        ) as MockStatus:
            # Mock status validation
            MockStatus.validate_transition.side_effect = (
                lambda from_state, to_state: to_state
                in valid_transitions.get(from_state, [])
            )
    ...
    def test_tournament_progress_tracking_accuracy(self):
        ...
        with patch(
            "keisei.evaluation.core.background_tournament.TournamentProgress"
        ) as MockProgress:
    ...
    def test_resource_cleanup_and_memory_management(self):
        ...
        with patch(
            ...
            manager.get_memory_usage.side_effect = [
                initial_memory,
                peak_memory,
                final_memory,
            ]
...
class TestTournamentScheduling:
    ...
    def test_tournament_queue_management(self):
        ...
        mock_scheduler.add_to_queue.return_value = {
            "position": 2,
            "estimated_wait": 300,
        }
    ...
    def test_priority_scheduling(self):
        ...
        result = mock_scheduler.schedule_with_priority(
            tournament_id="priority_tournament", priority="high"
        )
