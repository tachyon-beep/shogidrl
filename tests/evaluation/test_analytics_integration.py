...
from keisei.evaluation.core.evaluation_context import (
    AgentInfo,
    EvaluationContext,
    OpponentInfo,
)
...
class TestAnalyticsIntegration:
        ...
        for i in range(5):
                ...
                games.append(
                    GameResult(
                        ...
                        agent_info=AgentInfo(
                            name="test_agent", version="1.0", metadata={}
                        ),
                        opponent_info=OpponentInfo(
                            name="test_opponent", type="random", metadata={}
                        ),
                        metadata={
                            "timestamp": base_time + timedelta(days=i, minutes=j * 10)
                        },
                    )
                )
            ...
            result = EvaluationResult(
                ...
                summary_stats=SummaryStats(
                    ...
                    avg_duration_seconds=sum(g.duration_seconds for g in games)
                    / len(games),
                ),
                analytics_data={},
            )
    ...
    def test_analytics_statistical_comparison(
        self, analytics, sample_evaluation_results
    ):
    ...
    def test_analytics_error_handling(self, analytics, sample_evaluation_context):
        ...
        single_trend = analytics.analyze_trends(
            [(datetime.now(), single_result)], "win_rate"
        )
