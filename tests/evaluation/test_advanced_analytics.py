...
class TestAdvancedAnalytics:
    ...
    def test_statistical_analysis_algorithm_validation(self):
        ...
        with patch(
            "keisei.evaluation.analytics.advanced_analytics.AdvancedAnalytics"
        ) as MockAnalytics:
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            with patch(
                ...
                report = analytics.generate_report(
                    self.test_results, output_path=str(report_path), format="html"
                )
        ...
        with patch(
            ...
            for case in test_cases:
                ...
                power_analysis = analytics.compute_statistical_power(
                    sample_size=case["sample_size"], effect_size=case["effect_size"]
                )
    ...
    def test_integration_with_evaluation_results(self):
        ...
        eval_result = EvaluationResult(
            context=context, games=self.test_results, summary_stats=Mock()
        )
