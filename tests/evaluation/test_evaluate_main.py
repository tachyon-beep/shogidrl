...
def test_evaluation_manager_tournament_strategy_with_mock(tmp_path):
    ...
    config = create_evaluation_config(
        ...
        num_games=2,
        wandb_logging=False,
        opponent_pool_config=[{"name": "agent1", "type": "ppo", "checkpoint_path": "agent1.pth"}, 
    ...
    with patch('keisei.evaluation.core.base_evaluator.EvaluatorFactory.create') as mock_factory:
