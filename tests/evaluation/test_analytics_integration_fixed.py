...
class TestAnalyticsIntegration:
    ...
    def evaluation_results_series(self):
        ...
        for i in range(10):
            ...
            for j in range(wins):
                games.append(
                    GameResult(
                        ...
                        metadata={
                            "timestamp": base_time + timedelta(days=i, minutes=j * 5)
                        },
                    )
                )
            ...
            for j in range(losses):
                games.append(
                    GameResult(
                        ...
                        metadata={
                            "timestamp": base_time
                            + timedelta(days=i, minutes=(wins + j) * 5)
                        },
                    )
                )
            ...
            result = EvaluationResult(
                context=None, games=games, summary_stats=summary, analytics_data={}
            )
    ...
    def test_enhanced_manager_analytics_integration(self, evaluation_results_series):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            baseline_result = evaluation_results_series[0][
                1
            ]  # First result as baseline
