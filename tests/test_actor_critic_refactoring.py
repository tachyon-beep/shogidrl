...
def test_both_models_inherit_from_base():
    ...
    model2 = ActorCriticResTower(input_channels=46, num_actions_total=100, tower_depth=2, tower_width=32)
...
def test_shared_methods_work_identically():
    ...
    log_probs1, entropy1, value1_eval = model1.evaluate_actions(obs, actions, legal_mask)
    log_probs2, entropy2, value2_eval = model2.evaluate_actions(obs, actions, legal_mask)
