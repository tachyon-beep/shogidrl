...
class TestEnvManagerSeeding:
    ...
    def setup_method(self):
        ...
        from keisei.config_schema import EnvConfig, TrainingConfig, EvaluationConfig, LoggingConfig, WandBConfig, DemoConfig
    ...
    def test_env_manager_seeding_logging(self):
        ...
        assert mock_logger.called, "Logger function should have been called during environment setup"
...
class TestSeedingEdgeCases:
    ...
    def test_seed_memory_efficiency(self):
        ...
        assert not hasattr(game, '_seed_history') or len(getattr(game, '_seed_history', [])) <= 1
