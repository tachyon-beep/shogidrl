    ...
    def _write_to_file(self, formatted_message: str) -> None:
        ...
        if self.log_file_path:
            try:
                ...
                print(f"[LOGGER] Failed to write to log file: {formatted_message}", file=sys.stderr)
    
    def _write_to_console(self, formatted_message: str, style: Optional[str] = None) -> None:
...
def log_error_to_stderr(component: str, message: str, exception: Optional[Exception] = None) -> None:
    """
