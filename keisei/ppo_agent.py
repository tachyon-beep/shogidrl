...
class PPOAgent:
    ...
    def select_action(
        ...
        with torch.no_grad():
            ...
            action, log_prob, value = self.model.get_action_and_value(obs, legal_idx_tensor)
    ...
    def ppo_update(self, obs, actions, old_log_probs, returns, advantages, epochs=4, batch_size=32):
        obs = torch.stack(obs)
        ...
        for _ in range(epochs):
            ...
            for start in range(0, n, batch_size):
                ...
                log_probs, entropy, values = self.model.evaluate_actions(batch_obs, batch_actions)
